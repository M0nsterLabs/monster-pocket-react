...
export default {
  ...baseConfig.default,
  cabinetURL                  : '//account-demo0.templatemonsterdev.com/',
  accountAuthURL              : '//account-demo0.templatemonsterdev.com/auth/',
