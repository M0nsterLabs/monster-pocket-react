...
export default {
  ...baseConfig.default,
  cabinetURL                  : '//account-demo3.templatemonsterdev.com/',
  accountAuthURL              : '//account-demo3.templatemonsterdev.com/auth/',
